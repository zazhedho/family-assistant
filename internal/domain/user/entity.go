...
type Users struct {
	...
	BirthDate             *time.Time     `json:"-" gorm:"column:birth_date"`
	AgeVerificationMethod string         `json:"age_verification_method,omitempty" gorm:"column:age_verification_method"`
	AgeVerifiedAt         *time.Time     `json:"age_verified_at,omitempty" gorm:"column:age_verified_at"`
	PersonalSpaceID       string         `json:"-" gorm:"-"`
