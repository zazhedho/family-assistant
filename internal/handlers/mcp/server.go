...
func NewHTTPServer(cfg config.MCPConfig, resolver serviceidentity.Resolver, reminderService servicereminder.Service) *http.Server {
...
func NewServer(cfg config.MCPConfig, resolver serviceidentity.Resolver, reminderService servicereminder.Service) *http.Server {
...
func Listen(cfg config.MCPConfig, resolver serviceidentity.Resolver, reminderService servicereminder.Service) (*http.Server, net.Listener, error) {
	return listenMCP(cfg, resolver, reminderService, net.Listen)
}

func listenMCP(cfg config.MCPConfig, resolver serviceidentity.Resolver, reminderService servicereminder.Service, listen func(string, string) (net.Listener, error)) (*http.Server, net.Listener, error) {
